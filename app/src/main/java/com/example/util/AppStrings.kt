...
open class AppStrings(
    ...
    open val proBenefit1: String = "2016 and 2020 lines on the same day-count"
    open val proBenefit2: String = "Daily cycle log of what the app showed"
    open val proBenefit3: String = "Opt-in day-count alert that opens the chart"
    open val proBenefit4: String = "AI that reads the on-screen snapshot only"
    open val proBenefit5: String = "A coin's own history, or no line at all"
    ...
    open val proModalFeature1: String = "2016 and 2020 lines on the same day-count"
    open val proModalFeature2: String = "Daily cycle log of what the app showed"
    open val proModalFeature3: String = "Opt-in day-count alert that opens the chart"
    open val proModalFeature4: String = "AI that reads the on-screen snapshot only"
    open val proModalFeature5: String = "A coin's own history, or no line at all"
    open val proModalFeature6: String = "Educational history. Not a forecast and not advice."
